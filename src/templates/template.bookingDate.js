exports.tempMailBookingDate = (noBoking, to, bookingDate) => {
	return {
		from: 'codingstreetart@stack.com',
		to: to,
		subject: 'Booking Date Information',
		html: `
        <!DOCTYPE html>
        <html lang="en">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="card-title"><strong>Hello Dear ${to}</strong></p>
                        <p class="card-subtitle"><strong>Kepada user YTH </strong>hari ini adalah jadwal booking room anda, silahkan segera lakukan checkin:
                    </p>
